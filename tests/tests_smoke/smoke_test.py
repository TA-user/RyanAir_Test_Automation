...
def test_user_can_order_flights(browser, main_page, main_page_search_flights_tab, trip_viewer_page_flights_tab,
    ...
    main_page.element_interactions.send_text_in_field(LogInPopupLocators.EMAIL_FORM, ' ')
    main_page.element_interactions.send_text_in_field(LogInPopupLocators.PASSWORD_FORM, ' ')
