...
class TestFlightsOrder:
    ...
    def test_user_can_order_flights(browser, assertions, setup, main_page, main_page_search_flights_tab,
        ...
        assertions.visible_element_should_contain_phrase(FlightsTabLocators.ACTUAL_DESTINATION_LOCATION,
                                                         destination_airport)
        ...
        assertions.element_should_contain_phrase(TripPlannerLocators.DESTINATION_LOCATION_FIRST_FLIGHT,
                                                 destination_airport)
        assertions.element_should_contain_phrase(TripPlannerLocators.DEPART_LOCATION_SECOND_FLIGHT, depart_airport)
        assertions.element_should_contain_phrase(TripPlannerLocators.DESTINATION_LOCATION_SECOND_FLIGHT,
                                                 destination_airport)
        ...
        assertions.visible_element_should_contain_phrase(HeaderLocators.BASKET_DEPART_LOCATION_FIRST_FLIGHT,
                                                         depart_airport)
        assertions.visible_element_should_contain_phrase(HeaderLocators.BASKET_DESTINATION_LOCATION_FIRST_FLIGHT,
                                                         destination_airport)
        assertions.visible_element_should_contain_phrase(HeaderLocators.BASKET_DEPART_LOCATION_SECOND_FLIGHT,
                                                         destination_airport)
        assertions.visible_element_should_contain_phrase(HeaderLocators.BASKET_DESTINATION_LOCATION_SECOND_FLIGHT,
                                                         depart_airport)
        ...
        assertions.element_should_contain_phrase(PaymentPageLocators.DESTINATION_LOCATION_FIRST_FLIGHT,
                                                 destination_airport)
