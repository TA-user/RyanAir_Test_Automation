...
from .main_page_locators import SearchCarsTabLocators, CalendarWidgetLocators
...
class MainPageCarHireTab(BasePage):
    ...
    def choose_pick_up_location(self):
        self.element_interactions.send_text_in_field(SearchCarsTabLocators.CAR_LOCATION, self.pick_up_location)
