...
class PaymentPageLocators:
    ...
    DESTINATION_LOCATION_FIRST_FLIGHT = (By.CSS_SELECTOR, "div[data-ref='outbound'] div.flight-details span:nth-child(3)")
    DEPART_LOCATION_SECOND_FLIGHT = (By.CSS_SELECTOR, "div[data-ref='inbound'] div.flight-details span:nth-child(1)")
    DESTINATION_LOCATION_SECOND_FLIGHT = (By.CSS_SELECTOR, "div[data-ref='inbound'] div.flight-details span:nth-child(3)")
