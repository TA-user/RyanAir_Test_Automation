...
class TestHotelBooking:
    ...
    def test_user_can_book_hotel(self, destination, check_in_date, check_out_date, assertions, setup, main_page,
                                 main_page_search_hotels_tab, hotels_list_page, hotel_main_page, hotel_page):
        ...
        assertions.element_text_should_contain_formatted_date(HotelsListPageLocators.ACTUAL_DATES,
                                                              hotels_list_page.hotels_search_date_format, check_in_date)
        assertions.element_text_should_contain_formatted_date(HotelsListPageLocators.ACTUAL_DATES,
                                                              hotels_list_page.hotels_search_date_format,
                                                              check_out_date)
        ...
        assertions.element_text_should_contain_formatted_date(HotelPageLocators.ACTUAL_DATES,
                                                              hotel_page.hotels_search_date_format,
                                                              check_in_date)
        assertions.element_text_should_contain_formatted_date(HotelPageLocators.ACTUAL_DATES,
                                                              hotel_page.hotels_search_date_format,
                                                              check_out_date)
        hotel_page.choose_cheapest_room()
        assertions.element_text_should_contain_formatted_date(RoomBookingPageLocators.ACTUAL_CHECK_IN_DATE,
                                                              RoomBookingPage.room_booking_date_format, check_in_date)
        assertions.element_text_should_contain_formatted_date(RoomBookingPageLocators.ACTUAL_CHECK_OUT_DATE,
                                                              RoomBookingPage.room_booking_date_format, check_out_date)
